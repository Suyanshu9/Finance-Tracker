    ...
    : QWidget(parent)
{
 //****************construct putton and widget************************//
    ...
    detailList->setStyleSheet( "QListWidget::item { background-color: black;border-bottom: 1px solid black; }"
...
//pushbutton declaration
   ...
   //right area
    ...
    budget->setStyleSheet("QLCDNumber { background-color: white; color: black; }");
    ...
    ratio->setStyleSheet("QProgressBar::chunk { background-color: #4CAF50; } "
